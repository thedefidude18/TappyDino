  ...
  return (
    ...
    >
      <div className="flex flex-col flex-1 w-full h-full px-6 py-8 pb-24 mt-12 modal-body">
        ...
        />
        <h1 className="mt-4 text-3xl font-bold text-center uppercase text-white">
          TON Wallet
        </h1>
        <p className="mt-2.5 text-lg font-medium text-center text-gray-300">
      ...
      <Drawer open={openDrawer} onOpenChange={setOpenDrawer}>
        ...
        <p className="mx-auto mb-6 text-sm text-center text-gray-300 max-w-72">
          {isConnected
        ...
        {isConnected ? (
          ...
          <button
            className="flex items-center justify-center py-0 px-3 rounded-xl font-bold h-11 text-sm w-full bg-[linear-gradient(98deg,#35a6eb_3.58%,#309adb_101.32%)] text-white"
            onClick={() => {
